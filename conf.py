...
# is in the manual.
COMMENT_SYSTEM_ID = "coborski/neocities"
...
# (translatable)
BODY_END = ' <script src="https://tinylytics.app/embed/ZQjnVaa2YYPCDkdHDEJd.js?hits&kudos=❤️" defer></script> '
